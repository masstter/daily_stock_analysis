...
class DimensionScorer:
    ...
    def calculate_scores(self, analysis_data: Dict[str, Any]) -> Dict[str, int]:
        """
        计算多维度评分
        ...
        scores = {
            ...
            'ma_score': self._calculate_ma_score(analysis_data),
            'volume_score': self._calculate_volume_score(analysis_data),
            'pattern_score': self._calculate_pattern_score(analysis_data),

            # 基本面评分
            'fundamental_score': self._calculate_fundamental_score(analysis_data),
            'valuation_score': self._calculate_valuation_score(analysis_data),
            'growth_score': self._calculate_growth_score(analysis_data),

            # 消息面评分
            'sentiment_score': self._calculate_sentiment_score(analysis_data),
            'news_score': self._calculate_news_score(analysis_data),
            'catalyst_score': self._calculate_catalyst_score(analysis_data),
        }
    ...
    def _calculate_technical_score(self, data: Dict[str, Any]) -> int:
        ...
        for pattern in positive_patterns:
            if re.search(pattern, technical_analysis):
                score += 10
